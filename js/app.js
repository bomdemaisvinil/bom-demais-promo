...
const CONFIG = {
  ...
  urlEntradas: "https://entradium.com/events/bom-demais-vinil-2027-valencia",
...
/* =========================================================
   Eyebrow — "PRIMER LOTE / ABIERTO" es una imagen (misma
   tipografía que el resto del cartel), con una versión por
   idioma. Para cambiar este texto en el futuro, sustituye los
   tres archivos assets/word-eyebrow-es.png / -en.png / -pt.png.
   ========================================================= */
const EYEBROW = {
  es: { src: "assets/word-eyebrow-es.png", alt: "Primer lote abierto" },
  en: { src: "assets/word-eyebrow-en.png", alt: "First batch open" },
  pt: { src: "assets/word-eyebrow-pt.png", alt: "Primeiro lote aberto" }
};
...
function applyLang(lang){
  ...
  const eyebrowImg = document.getElementById("eyebrow-img");
  if(eyebrowImg && EYEBROW[lang]){
    eyebrowImg.src = EYEBROW[lang].src;
    eyebrowImg.alt = EYEBROW[lang].alt;
  }
